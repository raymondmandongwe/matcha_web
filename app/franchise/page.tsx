...
export default function FranchisePage() {
  return (
    <main>
      ...
      {/* Process */}
      <section aria-labelledby="franchise-process-heading" className="bg-matcha-dark px-6 py-16 sm:py-24">
        ...
        <div className="mx-auto max-w-xl">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a
              ...
              className="rounded-full bg-matcha-dark px-7 py-3.5 text-sm font-semibold text-cream transition-colors hover:bg-[#162519]"
            >
