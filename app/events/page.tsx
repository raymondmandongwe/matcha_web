    ...
    <main>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid grid-cols-1 gap-px bg-cream/10 sm:grid-cols-2 lg:grid-cols-4">
            {PARTNERS.map((partner) => (
              <div key={partner.name} className="bg-matcha-dark p-8 transition-colors hover:bg-[#128A00]">
      ...
      <section className="px-6 py-20 text-center">
        <div className="mx-auto max-w-xl">
          ...
          <Link
            href="/contact"
            className="mt-8 inline-flex items-center gap-2 rounded-full bg-matcha-dark px-7 py-3.5 text-sm font-semibold text-cream transition-colors hover:bg-[#128A00]"
          >
            Get in Touch →
          </Link>
        </div>
