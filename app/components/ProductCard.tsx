      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-4 flex gap-2">
          <a
            ...
            className="flex-1 rounded-full bg-matcha-dark py-2.5 text-center text-sm font-medium text-cream transition-colors hover:bg-[#162519] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-matcha-mid"
          >
            View Product
          </a>
          <a
