...
export function ManufacturerInfo() {
  return (
    <section aria-labelledby="manufacturer-heading" className="mx-auto max-w-5xl px-6 py-16 sm:py-24">
      <h2 id="manufacturer-heading" className="font-[family-name:var(--font-display)] text-3xl font-semibold text-matcha-dark sm:text-4xl">
        Our Partners
      </h2>
      <div className="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2">
        {MANUFACTURERS.map((manufacturer) => (
          <div key={manufacturer.name} className="border-t border-matcha-dark/15 pt-5">
            ...
            <p className="mt-3 text-sm leading-relaxed text-[#128A00]/75">{manufacturer.description}</p>
          </div>
        ))}
      </div>
    </section>
