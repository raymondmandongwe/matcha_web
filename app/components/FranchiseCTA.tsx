...
export function FranchiseCTA() {
  return (
    <section aria-labelledby="franchise-cta-heading" className="bg-[#F7F2E8] px-6 py-20">
      <div className="mx-auto max-w-5xl overflow-hidden rounded-3xl bg-matcha-dark">
        <div className="grid grid-cols-1 gap-0 lg:grid-cols-2">
          <div className="p-10 sm:p-14">
            ...
            <Link
              href="/franchise"
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-gold px-6 py-3 text-sm font-semibold text-matcha-dark transition-colors hover:bg-[#b8913f]"
            >
